...
public class GameData : MonoBehaviour
{
    ...
    public bool IsYourScoreRankWorthy(float score)
    {
    ...
    public void AddPlayerDataToRankPlayersData(RankPlayerData your_player_data)
    {
        if (rank_players_data.Count > 0)
        {
            ...
            if (rank_players_data.Count <= 4)
            {
                rank_players_data.Add(your_player_data);
            }
            else
            {
                rank_players_data[4] = your_player_data;
            }
...
public class RankPlayerData
{
    ...
    private float player_score_ = 2.99f;
    public RankPlayerData()
    {

    }
    public RankPlayerData(string name, float score)
    {
        player_name_ = name;
        player_score_ = score;
    }

    public float get_player_score_data()
    {
        return player_score_;
    }
    public void set_player_score_data(float change_score)
    {
