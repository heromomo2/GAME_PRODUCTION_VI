...
public class BuiltInDifficultySystem
{
    ...
    int difficuly_threshold_one, difficuly_threshold_two, difficuly_threshold_three;
    ...
    // Constructor
    public BuiltInDifficultySystem(int difficultyCounter, int Difficulythresholdone, int Difficulythresholdtwo, int Difficulythresholdthree, float Speeddifficuly, float Maxspeeddifficuly, float Minspeeddifficuly)
    {
