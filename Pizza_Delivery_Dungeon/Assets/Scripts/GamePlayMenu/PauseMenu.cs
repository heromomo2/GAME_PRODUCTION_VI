...
{
    public GameObject pause_resume_button = null;
    ...
    void Start()
    {
        ...
        {
            if (go.name == "ResumeButton")
                pause_resume_button = go;
            else if (go.name == "QuitButton")
                pause_quit_button = go;

        }
        pause_resume_button.GetComponent<Button>().onClick.AddListener(PauseResureButtonOnPress);
